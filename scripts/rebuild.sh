...
# Rebuild script for AlphaScrabble

set -e

echo "🔨 Rebuilding AlphaScrabble"
echo "=========================="
...
if python -c "import alphascrabble" 2>/dev/null; then
    echo "✅ AlphaScrabble rebuilt successfully!"
else
    echo "❌ AlphaScrabble rebuild failed"
    exit 1
fi
...
echo ""
echo "Next steps:"
echo "1. Run './scripts/run_demo.sh' to test the rebuild"
